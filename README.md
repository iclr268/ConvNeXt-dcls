...
This is an implementation of the experiments using ConvNeXt-dcls models described in the paper 268 under double blind review (iclr 2023).

To install DCLS please follow the link: [DCLS](https://github.com/iclr268/Dilated-Convolution-with-Learnable-Spacings-PyTorch).
